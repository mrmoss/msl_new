...
#g++ udp_client.cpp ../socket.cpp ../string.cpp ../time.cpp -o udp_client -O -Wall -std=c++11
#gcc ../tomcrypt/*.c -I../tomcrypt/ -c -Wall -Wno-implicit-function-declaration
g++ crypto_test.cpp ../crypto.cpp ../string.cpp -o crypto_test -O -Wall -std=c++11 -lcrypto #-lgdi32
...
#g++ -pthread -lpthread -framework IOKit -framework CoreFoundation -ggdb joystick_test.cpp ../joystick.cpp ../time.cpp -o joystick_test -O -Wall -std=c++11
